...
<div class="site-wrap">
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black">Vous pouvez changer l'équipe</h2>
                </div>
                <div class="col-md-7">
                    <form action="formEditTeam.php" method="post">
                                    ...
                                    foreach ($team as $teamVale)
                                    {
                                        echo "                                                            
                                                            <tr>
                                                                ...
                                                                <td>Nom</td>
                                                                <td><input value =\"$teamVale[name]\" \"type=\"text\" class=\"form-control\" id=\"name\" name=\"name\"></td>
