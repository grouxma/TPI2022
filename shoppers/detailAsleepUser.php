...
<div class="site-wrap">
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black">Voulez-vous activer cet utilisateur ?    <a href="asleepCoaches.php" class="btn btn-sm btn-primary">Retour</a></h2>
                </div>
                <div class="col-md-7">
                    <!--CHANGER CETTE ACTION QUI PERMETTRA D'ENVOYER CE FORMULAIRE A LA PAGE QUI CONVIENT !!-->
                    <form action="formwakeUser.php" method="post">
                        <div class="p-3 p-lg-5 border">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <input type="submit" class="btn btn-primary btn-lg btn-block" value="Activer cet utililistateur">
                                </div>
                            </div>
                        </div>
                    </form>
