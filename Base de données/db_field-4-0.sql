...
CREATE TABLE teams(
	...
	,CONSTRAINT teams_towns0_FK FOREIGN KEY (id_towns) REFERENCES towns(id)
)ENGINE=InnoDB;
...
CREATE TABLE books(
	...
	,CONSTRAINT books_PK PRIMARY KEY (id,id_teams)

	,CONSTRAINT books_fields_FK FOREIGN KEY (id) REFERENCES fields(id)
	,CONSTRAINT books_teams0_FK FOREIGN KEY (id_teams) REFERENCES teams(id)
)ENGINE=InnoDB;
