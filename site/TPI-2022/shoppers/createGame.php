    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <form action="createGameForm.php" method="post">
                    <div class="p-3 p-lg-5 border">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="teams" class="text-black">Choississer Votre équipe adverse <span class="text-danger">*</span></label>
                                <select class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name = "field">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="teams" class="text-black">Choisissez une durée en demie-heure <span class="text-danger">*</span></label>
                                <select class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name = "field">
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                        <option>1</option>
                                        <option>2</option>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="selectField" class="text-black">Choississer le terrain <span class="text-danger">*</span></label>
                                <select class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name = "field">
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
