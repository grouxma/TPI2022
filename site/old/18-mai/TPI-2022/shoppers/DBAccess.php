...
class DBAccess
{
    ...
    public function addUser($surname,$firstname,$phoneNumber,$email,$password)
    {
        $sql = "INSERT INTO `users` (id, surname, firstname, phoneNumber, email, password, admin) VALUES (NULL, '$surname', '$firstname', '$phoneNumber', '$email', '$password', 0)";
        // Execute request
        return $this->executeSqlRequest($sql);
    }
